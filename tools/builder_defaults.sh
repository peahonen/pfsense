...
export MODULES_OVERRIDE=${MODULES_OVERRIDE:-"usb/ipheth cryptodev i2c ipmi ndis ipfw ipdivert dummynet fdescfs opensolaris zfs if_stf coretemp amdtemp aesni sfxge hwpmc vmm nmdm ix ixv"}
